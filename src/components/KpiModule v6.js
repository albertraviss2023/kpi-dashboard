...
import {
    ...
    Card, CardContent, Modal, IconButton, useMediaQuery, LinearProgress, Skeleton, Fade, Slide,
    Table, TableBody, TableCell, TableContainer, TableHead, TableRow,
    ThemeProvider, createTheme
} from '@mui/material';
import { keyframes } from '@mui/system'; // Fix: Import keyframes from @mui/system
import {
...
// Create a subtle edge glow animation
const edgeGlowAnimation = keyframes`
  0% { opacity: 0.4; }
  50% { opacity: 0.8; }
  100% { opacity: 0.4; }
`;
        ...
        <Grid item xs={12} sm={6} md={4} lg={4}>
            <Fade in={true} style={{ transitionDelay: `${index * 50}ms` }}>
                ...
                >
                    ...
                    <Box
                        sx={{
                            ...
                            background: isSelected 
                                ? `linear-gradient(45deg, ${alpha(ndaColors.primary, 0.2)}, ${alpha(ndaColors.secondary, 0.2)}, ${alpha(ndaColors.accent, 0.2)})`
                                : `linear-gradient(45deg, ${alpha(ndaColors.primary, 0.1)}, ${alpha(ndaColors.secondary, 0.1)}, ${alpha(ndaColors.accent, 0.1)})`,
                            animation: `${edgeGlowAnimation} 3s ease infinite`,
                    ...
                    <Card
                        elevation={isSelected || isHighlighted ? 4 : 2}
                        sx={{
                            height: '100%',
                            position: 'relative',
                            zIndex: 1,
                            border: '1px solid',
                            borderColor: isSelected ? 'primary.main' : isHighlighted ? 'secondary.main' : 'divider',
                            background: (theme) => 
                                isSelected 
                                    ? `linear-gradient(135deg, ${alpha(theme.palette.primary.main, 0.03)}, ${alpha(theme.palette.primary.main, 0.06)})`
                        ...
                        <CardContent>
                            ...
                            {value !== null && (
                                <LinearProgress
                                    ...
                                    color={status}
                                    sx={{ height: 6, borderRadius: 3, mt: 1.5, transition: 'all 0.3s ease' }}
                                />
                            )}
                        </CardContent>
                    </Card>
