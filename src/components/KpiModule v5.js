            ...
            <Fade in={true} style={{ transitionDelay: `${index * 50}ms` }}>
                <Card
                    ...
                    sx={{
                        ...
                        cursor: 'pointer',
                        border: '1px solid',
                        borderColor: isSelected ? alpha(ndaColors.primary, 0.5) : isHighlighted ? alpha(ndaColors.secondary, 0.5) : 'transparent',
                        borderRadius: '16px',
                        overflow: 'hidden',
                        backgroundColor: isSelected ? alpha(ndaColors.primary, 0.05) : 'background.paper',
                        ...
                        '&:hover, &:focus': {
                            ...
                            boxShadow: `0 8px 16px ${alpha(ndaColors.primary, 0.2)}, 0 0 12px ${alpha(ndaColors.secondary, 0.3)}`,
                            '& .card-overlay': {
                                opacity: 0.1,
                            },
                            '& .card-glow': {
                        ...
                        '& .card-overlay': {
                            ...
                            right: 0,
                            bottom: 0,
                            background: `linear-gradient(45deg, ${alpha(ndaColors.primary, 0.1)}, ${alpha(ndaColors.secondary, 0.1)})`,
                            opacity: 0,
                        ...
                        '& .card-glow': {
                            ...
                            right: '-1px',
                            bottom: '-1px',
                            background: `conic-gradient(from 0deg at 50% 50%, ${ndaColors.primary} 0deg, ${ndaColors.secondary} 90deg, ${ndaColors.accent} 180deg, ${ndaColors.primary} 360deg)`,
                            opacity: 0,
                            transition: 'opacity 0.5s ease-in-out',
                            zIndex: -1,
                            borderRadius: '17px',
                            boxShadow: `0 0 8px 2px ${alpha(ndaColors.primary, 0.4)}`,
                        },
                    }}
                    tabIndex={0}
                >
...
const KpiModule = () => {
    ...
    const allQuarters = [...new Set(Object.values(quarterlyData.MA).flatMap(kpi => kpi.data.map(item => item.quarter)))].sort((a, b) => {
        const [qA, yearA] = a.split(' '); const [qB, yearB] = b.split(' ');
