...
// Helper: Generate linear progression for a value over quarters with noise for realism
...
// Helper: Generate decreasing linear progression for avgDays with noise
...
// Helper: Generate num/den pairs with linear progression and noise
...
// Helper: Generate sample_n with linear progression and noise
...
// Helper: Generate started/completed/open with patterns and noise
...
// Helper: Generate bottleneck metrics with patterns and noise
...
// Generator for quarterlyVolumes
...
// Generator for inspectionVolumes
...
// Generator for processStepCounts
...
// Generator for bottleneckData (example for MA Technical Dossier Review, extend for others)
const generateBottleneckData = () => ({
  MA: {
    ...
    // Add generators for other steps like Queries to Applicant, Decision Issued similarly
...
export const quarterlyData = generateQuarterlyData();
export const processStepData = generateProcessStepData();
export const kpiCounts = generateKpiCounts();
export const quarterlyVolumes = generateQuarterlyVolumes();
export const inspectionVolumes = generateInspectionVolumes();
export const processStepCounts = generateProcessStepCounts();
export const bottleneckData = generateBottleneckData();